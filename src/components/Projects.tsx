...
const projectsData: ProjectProps[] = [
  ...
  {
    title: "24K QPS 달성을 위한 Kubernetes 기반 고성능 시스템 설계",
    category: "프로젝트",
    ...
    impact: [
      "시스템 처리량 900% 향상: 기존 1K RPS → 9K RPS 달성",
      "인프라 안정성 확보: PDB와 HPA를 통한 무중단 서비스 운영",
      "성능 병목 해결: Nginx 설정 최적화로 연결 제한 문제 해결",
    ],
...
const categories = ['프로젝트', '라이브러리', '인프라', '군복무'] as const;
